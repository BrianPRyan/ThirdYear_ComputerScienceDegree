...
bool Game::init(const char* title, int xpos, int ypos, int width, int height, bool fullscreen)
{
	...
	TheSoundManager::Instance()->load("assets/3BloodStream.wav", "music1", SOUND_MUSIC);
    TheSoundManager::Instance()->load("assets/boom.wav", "explode", SOUND_SFX);
    TheSoundManager::Instance()->load("assets/LaserEnemy.wav", "shoot", SOUND_SFX);
	...
	//TheGameObjectFactory::Instance()->registerType("Soldier", new SoldierCreator());
